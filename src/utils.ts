...
export const Data: csv = {
  ...
  trump: {
    CNN: {
      data: [
        0.5576097863443311, 0.2237066479406411, -0.005791, -0.3163031615983668,
        -0.6278048780436008, -0.519597553692163, -0.4526346544188446,
        -0.4245046753780763, -0.4196597867897884, -0.6206324693177208,
        -0.5088877839106272, -0.3986204208468717, -0.32676779922688803,
      ],
      labels: [
        "2021-02",
        "2021-05",
    ...
    Fox: {
      data: [
        -0.44495428996131536, -0.8195390155914487, -0.4487731792925007,
        -0.1786314461275171, -0.3707843093392227, -0.00765157573371575,
        -0.07519516010508841, -0.4291812739311077, 0.0313723500750451,
        -0.4901962637783115, -0.4906200569547021, -0.3333336524419368,
        -0.530226575417001, -0.509617750450882, -0.43942055948341463,
        -0.41422593005161246,
      ],
      labels: [
        "2021-01",
